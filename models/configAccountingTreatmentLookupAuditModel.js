...
const configAccountingTreatmentLookupAuditSchema = new mongoose.Schema({
    atlId : {
        type: String,
        required: true
    },
    ...
    actionItemId:{
        type: mongoose.Schema.Types.ObjectId,
        ref : "config_accounting_treatment_lookups"
    },
    action: {
        type: String,
        default: '',
...
module.exports = mongoose.model("config_accounting_treatment_lookup_audits", configAccountingTreatmentLookupAuditSchema);
