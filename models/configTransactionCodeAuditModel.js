...
const configTransactionCodeAuditSchema = new mongoose.Schema({
    id : {
        type: String,
        required: true
    },
...
module.exports = mongoose.model("config_transaction_code_audits", configTransactionCodeAuditSchema);
